   ...
   Process {
    foreach ($MB in $MailboxList) {
        foreach ($User in $Users) {
            ...
            $body = {"<p>Ol&aacute; $((get-aduser -Identity $User -Properties mail).GivenName),
                      </p><p>Conforme foi requisitado, o acesso &agrave; caixa $MBalianca foi concedido &agrave; voc&ecirc;.</p>
                      ...
                      <p>&nbsp;</p>
                      <p><strong>Service Desk - SAO</strong></p>
                      <p>Information Technology &amp; Organization</p>
                      <p>Hamburg S&uuml;d Brasil Ltda</p>
                      <p>Alian&ccedil;a Navega&ccedil;&atilde;o e Log&iacute;stica Ltda</p>
                      <p>___________________________________________________</p>
                      <p>Rua Verbo Divino, 1547 04719-002 S&atilde;o Paulo, SP Brasil</p>
                      <p>Phone: +55 11 3775-4000</p>
                      <p>Email: <a href=""mailto:servicedesk-sao@hamburgsud.com"">servicedesk-sao@hamburgsud.com</a></p>"}
                      $body
